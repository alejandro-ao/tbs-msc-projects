...
def main():
    ...
    with st.sidebar:
        menu =st.selectbox('Menu', ('Home', 'User data analysis', 'Tweet Sentiment analysis'))

    if menu == "Home":
        st.write("Bienvenue chez nous!")
    elif menu == "User data analysis":
        # get user unique set
    ...
    elif menu == "Tweet Sentiment analysis":
        # get user unique set
        users_list = ['All'] + get_users(df_tweet)
        selected_user = st.selectbox('Choose a user', users_list)
