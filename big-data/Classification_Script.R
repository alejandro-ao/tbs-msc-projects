...
# Import the dataset
Bank_data<-read.csv2("./big-data/bank_full.csv")
summary(Bank_data)
...
# Na?ve Bayes algorithm: It is a classification technique based on Bayes' Theorem.

# Na?ve Bayes with R: Same example than previously
